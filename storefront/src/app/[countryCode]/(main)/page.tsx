...
import CategoriesOverview from "@modules/home/components/categories-overview"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Ambalaje Constanța - Soluții Complete de Ambalare",
    description:
      "Ambalaje de calitate pentru afacerea ta. Cutii de carton, pungi, folie stretch și multe altele.",
    type: "website",
    locale: "ro_RO",
